...
export type OrdersQuery = { __typename?: 'Query', orders: { __typename?: 'OrdersQueryResult', items: Array<{ __typename?: 'Order', id?: string | null, date?: string | null, totalSum?: number | null, expiresIn?: number | null, isCompleted?: boolean | null, products?: Array<{ __typename?: 'OrderProduct', covers?: Array<string> | null }> | null }> } };
...
export type ProductQuery = { __typename?: 'Query', product: { __typename?: 'Product', id: string, description: string, price: number, category: string, name: string, covers?: Array<string> | null, attributes: Array<{ __typename?: 'ProductAttribute', value: string, name: string }> } };
...
export type CreateProductMutation = { __typename?: 'Mutation', createProduct: { __typename?: 'Product', id: string, name: string, description: string, category: string, price: number, attributes: Array<{ __typename?: 'ProductAttribute', name: string, value: string }> } };
...
export type ProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductsQueryResult', pageData?: { __typename?: 'PageData', totalPages: number, page: number, pageSize: number } | null, items: Array<{ __typename?: 'Product', id: string, name: string, price: number, attributes: Array<{ __typename?: 'ProductAttribute', value: string, name: string }> }> } };
...
export type MainProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductsQueryResult', pageData?: { __typename?: 'PageData', totalPages: number, pageSize: number, page: number } | null, items: Array<{ __typename?: 'Product', name: string, category: string, price: number, description: string, id: string, covers?: Array<string> | null }> } };
...
export type ProductItemQueryQuery = { __typename?: 'Query', product: { __typename?: 'Product', id: string, category: string, covers?: Array<string> | null, description: string, price: number, name: string, attributes: Array<{ __typename?: 'ProductAttribute', name: string, value: string }> } };
