...
export type ProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductsQueryResult', pageData?: { __typename?: 'PageData', totalPages: number, page: number, pageSize: number } | null, items: Array<{ __typename?: 'Product', id: string, name: string, price: number, category: string, attributes: Array<{ __typename?: 'ProductAttribute', value: string, name: string }> }> } };
