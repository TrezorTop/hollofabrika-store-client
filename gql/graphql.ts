...
export type UpdateProductMutation = { __typename?: 'Mutation', updateProduct: { __typename?: 'Product', id: string, name: string, cover?: string | null, description: string, category: string, price: number, attributes: Array<{ __typename?: 'ProductAttribute', name: string, value: string }> } };
...
export type ProductQuery = { __typename?: 'Query', product: { __typename?: 'Product', id: string, description: string, price: number, category: string, name: string, attributes: Array<{ __typename?: 'ProductAttribute', value: string, name: string }> } };
